...
<div class="content bio">
	...
	<div class="left">
		...
		<a href="https://scholar.google.com/citations?hl=en&user=bMedjfUAAAAJ">
			<img class='scholar' style="height:30px" src="resources/googlescholar.png"></img>
		</a>
		<a href="https://github.com/JunweiLiang">
			<img class='github' style="height:30px" src="resources/github.png"></img>
		</a>
		<a href="https://www.linkedin.com/in/junweiliang/">
			<img class='linkedin' style="height:30px" src="resources/linkedin.png"></img>
		</a>
		<a href="https://www.youtube.com/channel/UC-z7ZWp8Rbu2xhxnbAL_bRQ">
			<img class='youtube' style="height:20px" title="My Youtube channel" src="resources/yt.png"></img>
		</a>
		<a href="https://www.zhihu.com/people/junwei-liang-50">
			<img class='zhihu' style="height:25px" title="My Zhihu page" src="resources/zhihu.png"></img>
		</a>
		<a href="https://www.semanticscholar.org/author/Junwei-Liang/1915796">
			<img class='semanticscholar' style="height:25px" src="resources/semantic_scholar.png"></img>
		</a>
		<a href="https://www.researchgate.net/profile/Junwei_Liang3">
			<img class='researchgate' style="height:25px" src="resources/rg.png"></img>
		</a>
		<a href="https://dblp.org/pers/hd/l/Liang_0001:Junwei">
	...
	<div class="right">
		...
		<div class="line office">
			Office: Gates and Hillman Centers 5513
		</div>
		<div class="line office">
...
<div class="content intro">
	...
	Greetings! I'm a 3rd year Ph.D. student under the supervision of <a href="https://scholar.google.com/citations?user=Py54GcEAAAAJ&hl=en">Prof. Alexander Hauptmann</a> at Carnegie Mellon University. <br/>
	My research interests are large-scale computer vision and natural language processing. <br/>
	I am also doing research/building tools for event reconstruction from unorganized social media videos for public safety projects. <br/>
</div>
...
<div class="content news">
	...
	<ul>
		<li>
			[12/2019] <a href="https://next.cs.cmu.edu/multiverse/index.html"><span style="font-style: italic;">Multiverse</span></a> paper is out!
		</li>
		<li>
		...
		<li>
			[06/2019] Presented Future Prediction paper at <span style="font-weight:bold">CVPR 2019</span>. [<a href="https://twitter.com/jcniebles/status/1141366303921303552" target="_blank">Tweets</a>]
		</li>
		...
		<li>[02/2019] <span style="font-weight:bold">Future activity & path prediction</span> paper reported by the media with <span style="font-weight:bold">30k+ views</span> in a week. <a href="https://next.cs.cmu.edu" target="_blank"><i title="Go to project page" class="icon-zoom-in"></i></a></li>
		<li>[12/2018] <span style="font-weight:bold">MemexQA</span> paper accepted by <span style="font-weight:bold">TPAMI</span>. <a href="https://memexqa.cs.cmu.edu" target="_blank"><i title="Go to project page" class="icon-zoom-in"></i></a></li>
		...
		<li>[02/2017] Two demo papers accepted by AAAI 2017.</li>
		...
		<li>[02/2016] One oral paper accepted by IJCAI 2016.</li>
	</ul>
</div>
...
<div class="content education">
	...
	<ul>
		<li>
			<span class="title">Ph.D. in Language and Information Technology</span> <div class="float-right time">2017 - present</div>
		...
		<li>
			<span class="title">M.S. in Language Technologies</span> <div class="float-right time">2015 - 2017</div>
			<div class="info">School of Computer Science, Carnegie Mellon University</div>
			<div class="info">Advisor: <a href="https://scholar.google.com/citations?user=Py54GcEAAAAJ&hl=en">Alexander Hauptmann</a></div>
		</li>
		<li>
...
<div class="content honors" name='honors'>
	...
	<ul>
		<li>Baidu Scholarship (10 recipients globally) <div class="float-right">2019</div></li>
...
<div class="content publications">
	...
	<ol>
		<li>
			...
			<div class="info text-info">Junwei Liang, Lu Jiang, Kevin Murphy, Ting Yu, Alexander Hauptmann</div>
			<div class="info">Preprint, 2019. </div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="https://arxiv.org/abs/1912.06445" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="https://next.cs.cmu.edu/multiverse/resources/arxiv.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-info" href="https://youtu.be/RW45YQHxIhk" target="_blank">Demo Video</a>
				<a class="btn btn-small btn-warning" href="https://next.cs.cmu.edu/multiverse" target="_blank">Project Page/Code/Model</a>
			</div>
			<div style="clear:both"></div>
		</li>
		<li>
			<!--<div class="imgblock"><img src="camera_ready/peekfuture.png"></img></div>-->
			<div class="imgblock"><img src="camera_ready/next.gif"></img></div>
			<span class="title">Peeking into the Future: Predicting Future Person Activities and Locations in Videos
			</span>
			<div class="info text-info">Junwei Liang, Lu Jiang, Juan Carlos Niebles, Alexander Hauptmann, Li Fei-Fei</div>
			<div class="info">In Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2019. <span class="text-warning">(Translated and reported by multiple Chinese media (<a href="https://weixin.sogou.com/weixin?type=1&s_from=input&query=%E9%87%8F%E5%AD%90%E4%BD%8D" target="_blank">量子位</a> & <a href="https://weixin.sogou.com/weixin?type=1&s_from=input&query=%E6%9C%BA%E5%99%A8%E4%B9%8B%E5%BF%83" target="_blank">机器之心</a>, 02/13/2019), with 30k+ views in a week.)</span> </div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="https://arxiv.org/abs/1902.03748" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/future19.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-info" href="https://www.youtube.com/watch?v=NyrGxGoS01U" target="_blank">Demo Video</a>
				<a class="btn btn-small btn-warning" href="https://next.cs.cmu.edu" target="_blank">Project Page/Code/Model</a>
			</div>
			<div style="clear:both"></div>
		</li>
		<li>
			...
			<div class="info text-info">Junwei Liang, Jay Aronson, Alexander Hauptmann</div>
			<div class="info">In Proceedings of the 27th ACM International Conference on Multimedia, 2019. <span class="text-warning"><br/>(Press coverage:
				<a href="https://pittsburgh.cbslocal.com/2019/11/20/cmu-develops-video-system-locate-mass-shooters/">
					<img class="press" src="resources/cbs.png"></img>
				</a>,
				<a href="https://www.cmu.edu/news/stories/archives/2019/november/system-locates-shooters-using-smartphone-video.html">
			...
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="https://www.cmu.edu/chrs/publications/pdf/shooter-localization-using-social-media-videos.pdf" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/mm19.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-info" href="https://www.youtube.com/watch?v=6q7LqqzrY2I" target="_blank">Demo Video</a>
				<a class="btn btn-small btn-warning" href="https://vera.cs.cmu.edu" target="_blank">Project Page</a>
			</div>
			<div style="clear:both"></div>
		</li>
		<li>
			...
			<div class="info text-info">Junwei Liang, Lu Jiang, Liangliang Cao, Yannis Kalantidis, Li-Jia Li, and Alexander Hauptmann</div>
			<div class="info">In IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI). <span class="text-warning">(Journal Regular Paper)</span> </div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="https://ieeexplore.ieee.org/document/8603827" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/tpami19.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-info" href="https://www.youtube.com/watch?v=hH-SXKA7hE8" target="_blank">Demo Video</a>
				<a class="btn btn-small btn-warning" href="https://memexqa.cs.cmu.edu" target="_blank">Code/Model/Dataset</a>
			</div>
			<div style="clear:both"></div>
		</li>
		<li>
			...
			<div class="info text-info">Junwei Liang, Lu Jiang, Liangliang Cao, Li-Jia Li, and Alexander Hauptmann</div>
			<div class="info">In Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2018. <span class="text-warning">(Spotlight Paper, <span style="font-weight:bold">6.8%</span> acceptance rate)</span></div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="camera_ready/cvpr18.pdf" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/cvpr18.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-warning" href="https://memexqa.cs.cmu.edu/fvta.html" target="_blank">Code/Model</a>
				<a  class="btn btn-small btn-info" href="https://youtu.be/TBOnKekODCI?t=1h11m29s" target="_blank">Presentation</a>
			</div>
			<div style="clear:both"></div>
		</li>
		...
		<li>
			...
			<div class="info text-info">Junwei Liang, Desai Fan, Han Lu, Poyao Huang, Jia Chen, Lu Jiang, and Alexander Hauptmann</div>
			<div class="info">In AAAI Conference on Artificial Intelligence (AAAI), 2017.</div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="https://aaai.org/ocs/index.php/AAAI/AAAI17/paper/download/14659/14033" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/aaai17_2.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-info" href="https://www.youtube.com/watch?v=DAhL5QL9Ko4" target="_blank">Demo Video</a>
				<a class="btn btn-small btn-warning" href="https://vera.cs.cmu.edu/VERA_3D_Reconstruction/" target="_blank">Project Page</a>
			</div>
			<div style="clear:both"></div>
		</li>
		...
		<li>
			...
			<div class="info text-info">Junwei Liang, Lu Jiang, and Alexander Hauptmann</div>
			<div class="info">In AAAI Conference on Artificial Intelligence (AAAI), 2017.</div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="camera_ready/aaai17_1.pdf" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/aaai17_1.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-info" href="https://www.youtube.com/watch?v=3he6VDwYMCQ" target="_blank">Demo Video</a>
				<a class="btn btn-small btn-info" href="posters/well_poster.pptx" target="_blank">Poster</a>
			</div>
			<div style="clear:both"></div>
		</li>
		...
		<li>
			...
			<div class="info text-info">Junwei Liang, Lu Jiang, Deyu Meng, and Alexander Hauptmann</div>
			<div class="info">In International Joint Conference on Artificial Intelligence (IJCAI), 2016.</div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="camera_ready/ijcai16.pdf" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/ijcai16.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-info" href="https://www.youtube.com/watch?v=3he6VDwYMCQ" target="_blank">Demo Video</a>
			</div>
			<div style="clear:both"></div>
		</li>
		<li>
			...
			<div class="info text-info">Qin Jin, and Junwei Liang</div>
			<div class="info">In ACM International Conference on Multimedia Retrieval (ICMR), 2016.</div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="camera_ready/icmr16.pdf" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/icmr16.bib" target="_blank">BibTex</a>
			</div>
			<div style="clear:both"></div>
		</li>
		...
		<li>
			...
			<div class="info text-info">Junwei Liang, Lu Jiang and Alexander Hauptmann</div>
			<div class="info">In IEEE International Conference on Acoustics, Speech, and Signal Processing (ICASSP), 2017.</div>
			<div class="stuff">
				<a class="btn btn-small btn-primary" href="camera_ready/icassp17_1.pdf" target="_blank">Paper</a>
				<a class="btn btn-small btn-success" href="camera_ready/icassp17_1.bib" target="_blank">BibTex</a>
				<a class="btn btn-small btn-info" href="https://www.youtube.com/watch?v=em-0CsJoqeU" target="_blank">Demo Video</a>
			</div>
			<div style="clear:both"></div>
		</li>
...
<div class="content research">
	...
	<ul>
		<li>
			<span class="title">Research Assistant at Carnegie Mellon University</span> <div class="float-right time">2015 - present</div>
			<div class="info">
				...
				I'm also the major contributor to the government-funded projects: <a href="https://www.nist.gov/communications-technology-laboratory/pscr" target="_blank">PSCR by NIST</a> (2017-2020), <a href="https://www.iarpa.gov/index.php/research-programs/diva" target="_blank">DIVA by IARPA</a> (2017-2021) and <a href="https://www.iarpa.gov/index.php/research-programs/aladdin-video" target="_blank">ALADDIN by IARPA</a> (2017).
...
<div class="content pro">
	...
	<ul>
		<li>
			<span class="title">Guest Lecture: Introduction to Machine Learning in Computer Vision [<a href="https://docs.google.com/presentation/d/1xvDyHBWIvn-Z5Mj-5Up47YvzET5zl6X0dTSQyFXf-v0/edit?usp=sharing" target="_blank">Slides</a>]</span><div class="float-right time">2020</div>
...
<div class="content pro">
	...
	<ul>
		<li>
			...
			<div class="info">IEEE Transactions on Circuits and Systems for Video Technology</div>
		</li>
		<li>
			<span class="title">Conference Reviewer</span>
			<div class="info">ACM Multimedia 2017</div>
			<div class="info">ACM Multimedia 2019</div>
		</li>
	</ul>
</div>
